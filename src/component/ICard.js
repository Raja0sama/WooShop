...
function ICard(props){
    ...
    return (
      <Card status={'info'}  style={{
        padding:0,
            borderWidth: 0, shadowColor: "#000",  margin:10,
            shadowOffset: {
              width: 0,
              height: 7,
            },
          ...
          footer={()=> <Footer onPress={() => props.navigation.navigate('Single', { id: item.id, product: item.productId })}  item={props.data} />}
